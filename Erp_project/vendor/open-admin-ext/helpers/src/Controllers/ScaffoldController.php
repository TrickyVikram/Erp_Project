...
class ScaffoldController extends Controller
{
    ...
    protected function backWithSuccess($paths, $message)
    {
        ...
        $formattedMessage = implode('<br/>', $messages);
        ...
        if ($startPos !== false) {
            ...
            $result = substr($string, $startPos);

            // Display the result

            // Save formatted message to RouteTable
            $save_routes = new RouteTable();
            $save_routes->routes = $result; // Convert array to string
            $save_routes->save();
